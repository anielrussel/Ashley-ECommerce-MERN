      ...
      <div className="lg:px-28 px-2 py-10">
        ...
        <div className="mt-10 font-jost">
          ...
          <p className="lg:text-lg text-md text-gray-700">
            Welcome to our enchanting flower emporium, where beauty blossoms
            with every petal. Explore our exquisite collection of handpicked
            blooms, carefully cultivated to ignite joy and evoke emotions. From
            vibrant bouquets to delicate arrangements, our flowers exude
            elegance and grace, perfect for any occasion. Immerse yourself in
            the fragrant world of nature's wonders and let our flowers weave
            their magic into your heart.
          </p>
        </div>
        ...
        <div className="mt-12 lg:mt-16">
          ...
          <div className="flex flex-wrap lg:px-28 px-2 gap-2 my-4 justify-center">
